...
begin # boilerplait to disable Pluto's package manger; explicitly run dev
	import Pkg
	dev = Pkg.develop
	dev(path="../")
	using Tethys
...
# ╔═╡ 0f39fb11-3ea0-4eee-9f21-37aa051bfff0
...
Tethys = "b72da442-09de-412e-b5ad-25e65360be4a"
...
[[Tethys]]
deps = ["BenchmarkTools", "Printf", "Random", "Revise", "StaticArrays"]
path = "../../home/jarvist/REPOS/Tethys.jl"
uuid = "b72da442-09de-412e-b5ad-25e65360be4a"
version = "0.1.0"
